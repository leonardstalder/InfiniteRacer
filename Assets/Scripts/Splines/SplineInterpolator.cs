...
public class SplineInterpolator : MonoBehaviour
{
	...
	void Start()
	{
		Debug.Log("COUNT"+mNodes.Count);
		Debug.Log(mNodes[0].Point);
		Debug.Log(mNodes[1].Point);
		Debug.Log(mNodes[2].Point);
		Debug.Log(mNodes[3].Point);
		Debug.Log(mNodes[4].Point);
		Instantiate(cube, GetHermiteInternal(3, 1f), GetSquad(3, 1f));
	}
